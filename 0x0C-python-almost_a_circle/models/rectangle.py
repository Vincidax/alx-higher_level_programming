#!/usr/bin/python3
"""This deals with properties of a a rectangle by importing Base class"""
...
class Rectangle(Base):
    ...
    def update(self, *args, **kwargs):
        """Update the attributes of the Rectangle using keyword arguments."""
        if args:
    ...
    def __str__(self):
        ...
        wi = self.__width
        he = self.__height
        return f"[Rectangle] ({self.id}) {self.__x}/{self.__y} - {wi}/{he}"
